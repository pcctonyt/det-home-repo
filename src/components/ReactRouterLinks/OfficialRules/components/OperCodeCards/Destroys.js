        ...
        <div className="label">
            <header>
                ...
                <div className="units-info">
                    <p className="bold lg-text">Use Operator Code:<span className="right"><h1 className="code-padding-top">(z)</h1></span></p>
                     <span className="right lg-text">Use with: G,L,S,A,Infantry vs. Fixed, all non-SDI protected Units in Firing Moves</span>
                </div>
                ...
                <div className="daily-value sm-text">
                    ...
                    <div className="divider"></div>
                        ...
                        <p className="no-divider"><em>F-SNzf3/h1</em>. A Fired Strategic Nuclear Unit destroys a 3 x 3 <em>County Be Gone!</em> block of squares (f3, f2, f1, g3, g2, g1, h3, h2, h1, assuming no SDI Defense)</p>
                    <div className="divider lg"></div>
