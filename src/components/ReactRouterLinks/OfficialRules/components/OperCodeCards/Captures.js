    ...
    <div className="det-cards" id="cards">
        ...
        <div className="label">
            <header>
                ...
                <div className="divider captures">
                ...
                <div className="units-info">
                    <p className="bold lg-text">Use Operator Code:<span className="right"><h1 className="code-padding-top">(x)</h1></span></p>
                     <span className="right lg-text">Use With: G,L,S,A,Infantry vs Moveable Units</span>
                </div>
                ...
                <div className="daily-value sm-text">
                    ...
                    <div className="divider"></div>
                        ...
                        <p className="no-divider"><em>G-xxd8</em>.  A General captures both a Mobile Nuclear Unit (first x, second slot) and a Mobile SDI Defense Unit (second x, third slot), but no Conventional Unit, on square d8.</p>
                    <div className="divider lg"></div>
                        <p className="note no-divider">NOTE:  The Shorthand syntax for Infantry Units capturing only another Conventional Unit WITHOUT OTHER UNITS is made (without writing the (x) operator) as follows: (letter of the file the Infantry starts on)(square code the Infantry captures).  Example: <em>ed5</em> (replaces exd5)  Also note that the "destroys" (z) operator can be used in this manner as well.</p>
                </div>        
        </div>
    </div>
  )
